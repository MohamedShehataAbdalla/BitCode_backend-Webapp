...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">البيانات الأساسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الأقسام المحذوفة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
										...
										<tbody class="">
                                            @forelse ($sections as $section)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $section->deleted_at }}</td>
                                                    <td class="text-center">

                                                        {{-- @can('class-show') --}}
                                                            <a class="btn btn-success btn-sm" href="{{ route('sections.restore',$section->id) }}" title="أسترجاع"><i class="fas fa-trash-restore"></i></a>
                                                        {{-- @endcan --}}
