...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">العمليات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ العملاء المحذوفة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
										...
										<tbody class="">
                                            @forelse ($customers as $customer)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $customer->deleted_at }}</td>
                                                    <td class="text-center">

                                                        {{-- @can('class-show') --}}
                                                            <a class="btn btn-success btn-sm" href="{{ route('customers.restore',$customer->id) }}" title="أسترجاع"><i class="fas fa-trash-restore"></i></a>
                                                        {{-- @endcan --}}

                                                       {{-- @can('حذف قسم') --}}
                                                        <a class="btn btn-sm btn-danger modal-effect" data-effect="effect-sign" href="#delete_Modal" title="حذف"
                                                            data-id="{{ $customer->id }}" data-name="{{ $customer->first_name }} {{ $customer->middle_name }} {{ $customer->last_name}}}" data-toggle="modal" >
