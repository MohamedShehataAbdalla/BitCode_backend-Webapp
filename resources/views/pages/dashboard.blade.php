									...
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{-- {{ number_format(\App\Models\Invoice::sum('total_due'),2) }} £ --}}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
												{{-- {{ \App\Models\Invoice::count() }} عدد الفواتير --}}
											</p>
										</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{-- {{ number_format(\App\Models\Invoice::where('payment_status','=','unpaid')->sum('total_due'),2) }} £ --}}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
												{{-- {{ \App\Models\Invoice::where('payment_status','=','unpaid')->count() }} عدد الفواتير --}}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
												{{-- %{{ \App\Models\Invoice::count() >= 1 ? round((\App\Models\Invoice::where('payment_status','=','unpaid')->count() / \App\Models\Invoice::count()) * 100 , 2 ) : 0 }} --}}
											</span>
										</span>
									</div>
								</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{-- {{ number_format(\App\Models\Invoice::where('payment_status','=','paid')->sum('total_due'),2) }} £ --}}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
												{{-- {{ \App\Models\Invoice::where('payment_status','=','paid')->count() }} عدد الفواتير --}}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
												{{-- %{{ \App\Models\Invoice::count() >= 1 ? round((\App\Models\Invoice::where('payment_status','=','paid')->count() / \App\Models\Invoice::count()) * 100 , 2 ) : 0 }} --}}
											</span>
										</span>
									</div>
								</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{-- {{ number_format(\App\Models\Invoice::where('payment_status','=','partial')->sum('total_due'),2) }} £ --}}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">
												{{-- {{ \App\Models\Invoice::where('payment_status','=','partial')->count() }} عدد الفواتير --}}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
												{{-- %{{ \App\Models\Invoice::count() >= 1 ? round((\App\Models\Invoice::where('payment_status','=','partial')->count() / \App\Models\Invoice::count()) * 100 , 2 ) : 0 }} --}}
											</span>
										</span>
									</div>
								</div>
				...
				<div class="row row-sm">
						...
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-0">حجم الفواتير</h4>
									<i class="mdi mdi-dots-horizontal text-gray"></i>
								</div>
								<p class="tx-12 text-muted mb-0">حجم الفواتير إلي بعض من حيث إجمالي الفواتير.</p>
							</div>
							<div class="card-body">
								{{-- {!! $chartjs->render() !!} --}}
							</div>
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							...
							<span class="d-block mg-b-20 text-muted tx-12">نسبة الفواتير إلي بعض من حيث عدد الفواتير.</span>
							<div class="">
								{{-- {!! $chartjs_2->render() !!} --}}
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="product-timeline card-body pt-2 mt-1">
								<ul class="timeline-1 mb-0">
									<li class="mt-0"> <i class="ti-pie-chart bg-primary-gradient text-white product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">total_due Products</span> <a href="#" class="float-left tx-11 text-muted">3 days ago</a>
										<p class="mb-0 text-muted tx-12">1.3k New Products</p>
									</li>
									<li class="mt-0"> <i class="mdi mdi-cart-outline bg-danger-gradient text-white product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">total_due Sales</span> <a href="#" class="float-left tx-11 text-muted">35 mins ago</a>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="d-flex align-items-center pb-2">
											<p class="mb-0">total_due Sales</p>
										</div>
