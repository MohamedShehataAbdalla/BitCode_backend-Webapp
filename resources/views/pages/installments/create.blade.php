...
@section('pageTitle','أضافة إيصال سداد')
@section('styles')
...
@section('page-header')
        ...
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                    <div class="d-flex">
                        <h4 class="content-title mb-0 my-auto">التحصيلات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ أضافة إيصال سداد</span>
                    </div>
                </div>
            </div>
        <!-- breadcrumb -->
...
@section('content')
        ...
        @include('layouts.alerts')
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form" id="search_invoice_form" action="{{ route('installments.create') }}" method="post" >{{ csrf_field() }}</form>
                        <form class="form" id="creation_invoice_form" action="{{ route('installments.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                            {{ csrf_field() }}

                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="invoice" class="form-label">أبحث عن الفاتورة</label>
                                        <div class="input-group">
                                            <input type="search" form="search_invoice_form" class="form-control" id="search_invoice_number" name="search_invoice_number" placeholder="INV-500"  value="{{old('search_invoice_number', $search_invoice_number)}}" autofocus  maxlength="250">
                                            <div class="input-group-prepend">
                                                <button type="submit" class="btn btn-secondary" form="search_invoice_form" ><i class="fas fa-search-dollar fa-lg"></i> بحث</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" id="invoice_id" name="invoice_id" value="{{old('invoice_id', $invoice_id)}}">
                                        <input type="text" class="form-control-plaintext @error('invoice_number') is-invalid @enderror" id="invoice_number"
                                            placeholder="INV-500"  value="{{old('invoice_number', $invoice_number)}}" readonly >
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control-plaintext @error('installment_number') is-invalid @enderror" id="installment_number" name="installment_number"
                                            placeholder="1"  value="{{old('installment_number', $installment_number)}}" readonly >
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control-plaintext @error('invoice_remaining') is-invalid @enderror" id="invoice_remaining" name="invoice_remaining"
                                            placeholder="0.00"  value="{{old('invoice_remaining', number_format($invoice_remaining , 2,'.', '')  )}}" readonly >
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('paid_amount') is-invalid @enderror" id="paid_amount" name="paid_amount"
                                            placeholder="0.00" step="0.01"  value="{{old('paid_amount')}}" >
                                        @error('paid_amount')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control-plaintext @error('remaining_amount') is-invalid @enderror" id="remaining_amount" name="remaining_amount"
                                            placeholder="0.00"  value="{{old('remaining_amount')}}" readonly >
