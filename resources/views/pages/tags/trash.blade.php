...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">البيانات الأساسية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ العلامات المحذوفة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
									...
									<table class="table text-md-nowrap table-hover table-striped" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-30p border-bottom-0">الأسم</th>
										...
										<tbody class="">
                                            @forelse ($tags as $tag)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $tag->deleted_at }}</td>
                                                    <td class="text-center">

                                                        {{-- @can('class-show') --}}
                                                            <a class="btn btn-success btn-sm" href="{{ route('tags.restore',$tag->id) }}" title="أسترجاع"><i class="fas fa-trash-restore"></i></a>
                                                        {{-- @endcan --}}
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">حذف العلامة</h6>
