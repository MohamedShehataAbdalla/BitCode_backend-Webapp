										...
										<tbody class="">
                                            @forelse ($invoices as $invoice)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $invoice->invoice_details->count() }}</td>
                                                    ...
                                                    <td class="text-center">
														<div class="dropdown">
															...
															<div  class="dropdown-menu tx-13">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('invoices.show',$invoice->id) }}"><i class="fas fa-receipt"></i> عرض الفاتورة</a>

                                                                <a class="dropdown-item" href="{{ route('invoice_details.show',$invoice->id) }}"><i class="fas fa-solid fa-binoculars"></i> عرض التفاصيل</a>
